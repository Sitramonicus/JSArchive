  ...
  constructor() {
    this.quests = new Map([["q1", {
      ...
      config: {
        ...
        taskConfig: { tasks: { WATCH_VIDEO: { target: 8 } } },
        application: { id: "1234" }
      },
...
// O7.30+ logs via console.debug; hook both so the armed-refresh path is simulated.
console.log = (...a) => { _log(...a); _maybeSim(...a); };
console.debug = (...a) => { _log(...a); _maybeSim(...a); };
