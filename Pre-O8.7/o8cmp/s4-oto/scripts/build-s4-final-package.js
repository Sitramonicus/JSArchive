...
console.log("=== Building O8.5-S4 / S5 Deliverables ===");
...
const finalBundlePath = path.join(PKG_DIR, "O8.5-S4-final-bundle.js");
...
fs.writeFileSync(path.join(PKG_DIR, "O8.5-S4-compressed-gzip.js"), gzipRunner);
fs.writeFileSync(path.join(PKG_DIR, "O8.5-S4-compressed-deflateraw.js"), deflateRawRunner);

console.log(`[Deliverable] O8.5-S4-compressed-gzip.js: ${(gzipRunner.length / 1024).toFixed(1)} KB`);
console.log(`[Deliverable] O8.5-S4-compressed-deflateraw.js: ${(deflateRawRunner.length / 1024).toFixed(1)} KB`);

// 6. Update SHA256SUMS.txt
const crypto = require("crypto");
const files = [
  "O8.5-S4-compressed-gzip.js",
  "O8.5-S4-compressed-deflateraw.js",
  "O8.5-S4-final-bundle.js"
];
const sums = [];
