...
//
// Input : /home/user/o8cmp/s4-shards/shards/shard-u.js
// Output: /home/user/o8cmp/s4-oto/u/shard-u-out.js
'use strict';
const fs = require('fs');
const JS = require('/home/user/o8cmp/seamless/jso/node_modules/javascript-obfuscator');

const src = fs.readFileSync('/home/user/o8cmp/s4-shards/shards/shard-u.js', 'utf8');
...
const p = '/home/user/o8cmp/s4-oto/u/shard-u-out.js';
fs.mkdirSync('/home/user/o8cmp/s4-oto/u', { recursive: true });
...
console.log('reversed unlock literal present:', out.includes('kcolbUelgooG'), '| bidi controls surviving:', /[\u202a-\u202e]/.test(out));
