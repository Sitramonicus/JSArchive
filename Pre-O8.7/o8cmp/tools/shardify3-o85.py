...
out.append('})();')
final = '\n'.join(out) + '\n'
open('/home/user/o8cmp/builds/O8.5-Shard-3.js', 'w', encoding='utf-8').write(final)
print('artifact lines:', final.count('\n'))

import os
os.makedirs('/home/user/o8cmp/attic/shard-out3', exist_ok=True)
for tag, wl in {'a': wA, 'm': wM, 'n1': wN1, 'e': wE, 'n2': wN2, 'aux': wAUX}.items():
    with open('/home/user/o8cmp/attic/shard-out3/shard-%s.js' % tag, 'w', encoding='utf-8') as f:
        f.write('\n'.join(wl) + '\n')
