...
(function (_0xmod) {
  ...
  const _0xe8a7 = (fn) => {
    ...
    return () => {
      const i = disposables.indexOf(tracked);
  ...
  (async () => {
    try {
      ...
      const _0xtaskValues = (() => {
        try {
          const values = _0xr2.store.values(_0x5[_0xq7]);
      ...
      const _0xdae0 = (ms, sig) => _0xr2.scheduler.sleep(ms, sig);
      ...
      const _0xsend = _0xr2.host.dispatcher(_0x8);
      ...
      const GoogleCall = (fn, critical = false) => async (opts) => {
        ...
        while (tries < 3 && !signal.aborted) {
          try {
            ...
            const res = await _0xr2.transport.call(fn, finalOpts);
      ...
      const _0xdg8n = (v, svalOverride) => {
        try {
          ...
          if (svalOverride === undefined) {
            try {
              const _0dvl = _0xr2.store.values(_0x5[_0xq7]);
      ...
      const _0xverifyDone = (v, cleanup) => { // silence backstop: play/stream are event-only; verify completion via store
        try {
          const _0v = _0xr2.store.values(_0x5[_0xq7]);
      ...
      const _0xlatencyFaC = async () => {
        ...
        try { const v = _0xr2.store.values(_0x5[_0xq7]); before = typeof v === 'function' && Array.isArray(Array.from(v.call(_0x5[_0xq7]))) ? 1 : 0; } catch (e) {}
        const slot = 7 + ((_0xmodules.length + _0xeligible.length) & 3);
        await new Promise(resolve => setTimeout(resolve, slot));
        const elapsed = Date.now() - t0;
        try { const v = _0xr2.store.values(_0x5[_0xq7]); after = typeof v === 'function' && Array.isArray(Array.from(v.call(_0x5[_0xq7]))) ? 1 : 0; } catch (e) {}
...
try { MemberCount.summary(); } catch (e) {}
  ...
  (function (_0xmod) {
    ...
    (() => {
      const _0xserialized = "<!--o814-c06--><section data-o814=\"c06\"><style>.o814-c06{color:#6b7280;display:block}</style><p class=\"o814-c06\">serialized decoy</p></section>";
      const _0xkind = "css-html";
