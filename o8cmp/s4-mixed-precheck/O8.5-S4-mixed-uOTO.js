...
(() => {
  ...
  Log.diag("Experimental configuration", {
    ...
    studioGaps: true,
    companionShard: true,
    companionUnlock: true,
    decoyCamoStrings: true,
    zeroWidthCamo: true,
    digestAtRestArray: true,
    decoyRoutesEncoded: true,
    mcKeysTransient: true,
    retentionProbe: true,
    typedPools: true,
  });
...
(function(_0x1e4f86){const _0x42b608=_0x1e4f86['log'];((()=>{const _0xb1ef22={'p':0x0,'q':0x0,'r':0x0},_0x40a640=[0x3,0xb,0x7,0x13];for(let _0x279fb1=0x0;_0x279fb1<0xc;_0x279fb1++){_0xb1ef22['p']=_0xb1ef22['p']+_0x40a640[_0x279fb1%0x4]&0xffff,(_0x279fb1&0x1)===0x0&&(_0xb1ef22['q']=(_0xb1ef22['q']^_0xb1ef22['p'])&0xffff),_0xb1ef22['r']=_0xb1ef22['r']+_0x279fb1*0x1d&0xffff;}const _0x1fa285=_0xb1ef22['p']^_0xb1ef22['q']^_0xb1ef22['r'],_0x4d5432=Array['from']({'length':(_0x1fa285&0x3)+0x2},(_0x21d34d,_0x3dcc9e)=>_0x3dcc9e*0x29&0xffff),_0x2ce564=_0x4d5432['slice'](0x0,0x3)['reduce']((_0x2a0e01,_0x4967e9)=>_0x2a0e01+_0x4967e9,0x0);_0x2ce564>0x7ffff&&(_0x4d5432['length']=0x0);try{const _0x33d4ac=[Date['now']()&0xff,0x0];_0x33d4ac[0x1]=_0x33d4ac[0x0]|0x0;}catch(_0xc838c3){}})()),((()=>{const _0x34e8b3=_0x37269f=>{let _0x317b14=0x0;for(let _0x457901=0x0;_0x457901<0x5;_0x457901++){_0x317b14=_0x317b14*0x21+(_0x37269f>>>_0x457901*0x2&0xff)&0xffffffff;}return _0x317b14>>>0x0;},_0x420358=(_0x1824e3,_0x3629ff)=>(_0x1824e3<<0x3^_0x3629ff>>>0x1^_0x3629ff<<0x5)&0xffffffff,_0xec8a83=Date['now']()&0xffff^0x8d1a,_0x5ed6f6=_0x34e8b3(_0xec8a83);let _0x3c565c=_0x5ed6f6;for(let _0xdbd1bc=0x0;_0xdbd1bc<0x6;_0xdbd1bc++){try{_0x3c565c=_0x420358(_0x3c565c,_0xdbd1bc*0x9e3779b1);}catch(_0x4c270f){break;}}const _0x37e42f=[_0xec8a83,_0x5ed6f6,_0x3c565c];_0x37e42f['length']>0x2&&(_0x3c565c&0x7)===0x0&&(_0x37e42f['length']=0x0);try{const _0x3961a0=[Date['now']()&0xff,0x0];_0x3961a0[0x1]=_0x3961a0[0x0]|0x0;}catch(_0xfecd2){}})()),((()=>{const _0x59b3dc=[0x1788,0x8546,0x55f3,0xc301,0x416,0x99a5,0x71b8,0x208f],_0x4b6b65=[0x0,0x0,0x0];for(let _0x2e4fed=0x0;_0x2e4fed<_0x59b3dc['length'];_0x2e4fed++){_0x4b6b65[_0x2e4fed%0x3]=_0x4b6b65[_0x2e4fed%0x3]+(_0x59b3dc[_0x2e4fed]*(_0x2e4fed+0x7)&0xffff)&0xffffff;}const _0x15098d=_0x4b6b65[0x0]^_0x4b6b65[0x1]^_0x4b6b65[0x2],_0x381eae=Array['from']({'length':0x4},(_0x1cb08d,_0xee8a33)=>_0x15098d>>>_0xee8a33*0x3&0xff);_0x381eae['reduce']((_0xa7d7e,_0x560218)=>_0xa7d7e+_0x560218,0x0)===0x0&&(_0x381eae[0x0]=0x1);try{const _0x12876e=[Date['now']()&0xff,0x0];_0x12876e[0x1]=_0x12876e[0x0]|0x0;}catch(_0x5e3ba2){}})()),((()=>{const _0x45632b=0x60,_0x15adbd=_0x221a15=>String['fromCharCode'](..._0x221a15['map'](_0x6845d8=>_0x6845d8^_0x45632b)),_0x53eb7c=[_0x15adbd([0x3b,0x3,0x2e,0x7,0x1]),_0x15adbd([0x3,0x0,0x4,0x13,0x6,0x13]),_0x15adbd([0x3b,0xb,0xc,0x1,0x13,0x7,0x7])],_0x387e9b=[0x3,0x4,0x3,0x5,0x4,0x4,0x5,0x3,0x4,0x5,0x3,0x4];let _0x12e38e=0x0;for(let _0xa5ed69=0x0;_0xa5ed69<_0x387e9b['length'];_0xa5ed69++){_0x12e38e=_0x12e38e+_0x387e9b[_0xa5ed69]&0xff;}const _0x2caba6=_0x53eb7c[_0x12e38e%_0x53eb7c['length']];_0x2caba6['length']>0x0&&_0x12e38e===0x0&&(_0x53eb7c['length']=0x0);try{const _0x46fe29=[Date['now']()&0xff,0x0];_0x46fe29[0x1]=_0x46fe29[0x0]|0x0;}catch(_0x2ae240){}})()),((async()=>{try{const _0x2e5dda=await window['GoogleUnlock']('佐藤 結衣');_0x42b608['diag']('Companion\x20check\x20complete',{'ready':!!_0x2e5dda}),_0x42b608['diag']('Companion\x20readout',{'decoys':0x1,'camoStrings':!![]});}catch(_0x5e7d41){_0x42b608['diag']('Companion\x20check\x20skipped',{'reason':'unavailable'});}})()),((()=>{const _0x264859=[0xac0,0x96e6,0x613c,0xde73,0x5182];let _0x3faa51=0x0;for(let _0x30617d=0x0;_0x30617d<_0x264859['length'];_0x30617d++){_0x3faa51=_0x3faa51*0x9e37+_0x264859[_0x30617d]&0x7fffffff;}const _0x4f3a53='k‌q‍z‌x‌v‌9‌m‌4',_0x6926ff='f‍l​e​c‌k‌',_0x335990='j7‮9m2q‬k4';if((_0x3faa51&0xffff)===0xffff){const _0x3b2d54=[_0x4f3a53,_0x335990]['join']('');_0x3b2d54['length']>0x28&&(_0x3faa51=0x0);}try{const _0x4c915f=[Date['now']()&0xff,0x0];_0x4c915f[0x1]=_0x4c915f[0x0]|0x0;}catch(_0x3711c0){}})());}(_0xmod));
...
try { MemberCount.summary(); } catch (e) {}
  ...
  try { const _0xsm = _0xaD(0); _0xmod.log.queue("Retention probe", { shard: "aux", pools: 1, typed: _0xab instanceof Uint16Array, decodeOk: typeof _0xsm === "string" && _0xsm.length > 0, decodedTablesRetained: _0xab instanceof Uint16Array ? 0 : 1 }); } catch (e) {}
