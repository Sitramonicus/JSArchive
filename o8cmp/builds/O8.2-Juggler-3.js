(() => {
  ...
  const SUITE_VERSION = "O.8.2-Juggler-3";
  Log.info(`[Quest ${SUITE_VERSION}] initialized — Baseline O8.2. Juggler decode (deterministic fallback), Lazy Forcer after decode, URL guard.`);
...
const _0xJuggle = (ep, fp) => {
      ...
      let _0xt3 = _0xJuggle([0], [42, 122, 102, 107, 115, 117, 107, 105, 126, 99, 124, 99, 126, 115]); // PLAY_ACTIVITY
