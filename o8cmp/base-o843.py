...
# Reads /tmp/o843-lex.js, writes /tmp/o843-base.js. Local only.
import re

src = open('/tmp/o843-lex.js', encoding='utf-8').read()
...
src = src.replace('O8.4.1 core — static lexicon, log-lock, studio gaps, refill queue, metamorphic decode.',
                  'O8.4.3 core — uniform phrase pools, log-lock, studio gaps, refill queue, metamorphic decode.')

open('/tmp/o843-base.js', 'w', encoding='utf-8').write(src)
print('digest', digest)
