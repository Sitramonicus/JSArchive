console.clear();
(() => {
  // module-sharding seam — stitched (O8.5). Shards are scope-isolated;
  // the ONLY shared surface is the _0xmod contract object below.
  const _0xmod = {};
...
try { MemberCount.summary(); } catch (e) {}
  ...
  (() => {
    const _0x221a0 = ["/intake/v2/vault/packet?src=85b5df","/intake/v3/metric/offset?src=75f5ca","/intake/v1/gauge/vault?src=a0929f","/intake/v4/window/leaf?src=884cd7","/intake/v8/retry/retry?src=6190f2","/intake/v7/phase/delta?src=9874bc","/intake/v8/cohort/leaf?src=1a3216","/intake/v3/scope/peer?src=c177ac","/intake/v4/delta/lease?src=fcf175","/intake/v7/helix/offset?src=67c9f2","/intake/v8/sample/digest?src=3b417a","/intake/v1/backoff/digest?src=4a2e90","/intake/v3/index/cycle?src=9627f6","/intake/v1/vault/stride?src=34a2a3","/intake/v4/packet/batch?src=82187b","/intake/v8/peer/mantle?src=eaa858","/intake/v9/weight/phase?src=f34147","/intake/v8/mantle/cohort?src=a86494","/intake/v9/harbor/mantle?src=4d5096","/intake/v3/quota/salt?src=ddd46f","/intake/v8/helix/orbit?src=6870de","/intake/v8/gauge/harbor?src=fa0c47","/intake/v5/vault/sample?src=ee0135","/intake/v3/weight/index?src=bf8472","/intake/v1/percentile/budget?src=ac3b2a","/intake/v9/vault/vault?src=4d85d1","/intake/v1/backoff/branch?src=856bff","/intake/v7/checksum/leaf?src=5d464e","/intake/v1/backoff/cohort?src=1ddb01","/intake/v2/leaf/buffer?src=706532","/intake/v6/cursor/branch?src=be6b8e","/intake/v9/budget/salt?src=024e28","/intake/v4/depth/leaf?src=abbdda","/intake/v5/vector/cycle?src=92f408","/intake/v2/index/gauge?src=10f9a5","/intake/v9/percentile/percentile?src=5f5439","/intake/v9/shard/gauge?src=d90699","/intake/v4/backoff/spindle?src=edf7d0","/intake/v4/helix/gauge?src=ed921d","/intake/v7/backoff/phase?src=320942","/intake/v4/retry/harbor?src=031cac","/intake/v1/prism/phase?src=f2fb6f","/intake/v7/spindle/serial?src=a50e42","/intake/v4/phase/checksum?src=447d0a","/intake/v5/gauge/stride?src=42abc1","/intake/v8/digest/shard?src=90df7c","/intake/v6/budget/metric?src=637035","/intake/v2/window/latency?src=2009d6","/intake/v5/vault/scope?src=5b2d73","/intake/v5/cycle/leaf?src=4ca240","/intake/v4/buffer/cursor?src=5178ee","/intake/v7/helix/cursor?src=99c2f6","/intake/v7/branch/budget?src=6b52a7","/intake/v1/window/delta?src=686449","/intake/v8/prism/quota?src=8e3c67","/intake/v5/batch/delta?src=d2efc7","/intake/v4/stride/quota?src=254ef8","/intake/v6/vault/mantle?src=c19695","/intake/v4/orbit/peer?src=06596e","/intake/v6/prism/beacon?src=3eb278","/intake/v9/salt/vector?src=8294e5","/intake/v8/retry/stride?src=2e23f2","/intake/v7/budget/index?src=8d1391"];
    const _0x221a1 = ["spindle_cohort_5bcc","vector_shard_04dd","metric_packet_8d90","packet_sample_e46e","batch_helix_c404","scope_branch_6bda","stride_harbor_3a87","orbit_delta_5925","branch_mantle_9409","index_sample_ebdf","scope_depth_c896","quota_branch_fe4a","phase_batch_6abf","branch_cursor_3d7b","orbit_branch_7ab7","harbor_offset_0abe","orbit_stride_8bc0","branch_delta_54c0","mantle_checksum_7560","prism_depth_f9cd","checksum_percentile_4c93","salt_vector_da40","prism_leaf_0623","percentile_prism_1782","relay_depth_2786","percentile_packet_1bd9","quota_index_8c22","buffer_shard_6d33","phase_mantle_cd3a","cycle_digest_72df","latency_serial_3d32","leaf_budget_039d","spindle_batch_9fa4","vault_depth_2b79","percentile_serial_795e","grant_prism_20fa","branch_digest_e5c9","index_depth_9410","throttle_latency_980f","orbit_throttle_3f51","orbit_scope_ebbf","phase_cycle_d517","harbor_cursor_f7cb","cohort_checksum_6fdc","vector_parity_e812","percentile_lease_ef43","spindle_orbit_b055","leaf_percentile_56c0","budget_lease_3ac2","sample_latency_24f2","phase_buffer_805f","serial_lease_1477","sample_salt_7d4c","anchor_percentile_f470","metric_salt_aaff","prism_quota_7307","shard_beacon_78fc","depth_cycle_fa10","index_phase_25f8","cycle_grant_5b45","throttle_mantle_0d06","relay_percentile_4534","budget_retry_4234","cycle_latency_ef35","vector_phase_1059","delta_throttle_9971"];
    const _0x221a2 = ["scope:436:8b187f3b","relay:823:542a11c3","buffer:251:8a39c928","branch:87:66db6653","cursor:802:e05f7fc1","cohort:394:577ce45b","helix:16:ca131517","percentile:548:4195d1c6","percentile:561:3c9e07d0","parity:204:c0d40be4","sample:149:3c71ea0d","cycle:244:375e88db","cohort:33:b633c62a","branch:894:78efdb6f","serial:418:886e9494","quota:259:597ac265","packet:61:a8d97818","salt:832:99101d29","relay:637:5e5396cf","harbor:749:b22a8920","delta:311:8de212a1","digest:143:496f6ff5","weight:861:53a1f1a9","relay:9:9af36509","backoff:474:f3dd23a9","budget:493:0704c493","index:12:863377f4","lease:849:66e0cec5","vault:756:f3efca0d","beacon:746:b14e4038","vector:213:3dde50a8","phase:309:67b2ee21","scope:160:901e66d3","parity:758:e466b725","window:607:eb1b55b8","scope:762:6f9e01ac","percentile:8:3a7dd976","backoff:759:fc831e4d","metric:704:9509af7b","branch:369:81c6ca26","mantle:703:dff6d11c","index:854:c638d5f0","helix:610:56a5be7f","retry:850:cbd305ce","harbor:351:afbbfa2e","window:476:58a3ce7e","anchor:354:349dec9d","index:223:a0df7a66","phase:58:4c4c4ab6","percentile:195:fafc7c00","salt:227:baac4eb7","buffer:386:28ebc932","anchor:364:d079a04a","harbor:186:ea3d3fb6","checksum:173:6df36098","beacon:661:650ee9f7","index:182:15de2491","parity:532:ad5638f9","depth:820:ca1a781f","shard:796:26a11474","packet:27:5ac76dba","index:202:b3423169","sample:335:3e3f7676","lease:235:80e016ee","leaf:487:79c5a4e6","cursor:298:032d643e","helix:362:cbd35e6a","mantle:688:68cf5133"];
    const _0x221f3 = (a, b) => { let s = 0; for (let i = 0; i < a.length; i++) s = (s + a.charCodeAt(i) * (i + 1)) % 65521; return s ^ (b || 0); };
    const _0x221f4 = (n) => { const o = []; for (let i = 0; i < n; i++) o.push((i * 2654435761) >>> 0); return o; };
    const _0x221f5 = (x) => { const t = new Uint8Array(16); for (let i = 0; i < 16; i++) t[i] = (x >>> (i * 2)) & 255; return t; };
    const _0x221f6 = (arr) => { let lo = 0, hi = arr.length - 1; while (lo < hi) { const m = (lo + hi) >>> 1; if ((arr[m] & 1) === 0) lo = m + 1; else hi = m; } return lo; };
    const _0x221f7 = (s) => { let r = ""; for (let i = s.length - 1; i >= 0; i--) r += s[i]; return r; };
    const _0x221f8 = (a, b) => { const out = []; for (let i = 0; i < a; i++) out.push((b[i] || 0) ^ (i * 7)); return out; };
    const _0x221f9 = (v) => { let h = 2166136261; const s = String(v); for (let i = 0; i < s.length; i++) { h ^= s.charCodeAt(i); h = Math.imul(h, 16777619); } return h >>> 0; };
    class _0x221ca { constructor(seed) { this.seed = seed; this.slots = new Map(); } put(k, v) { this.slots.set(k, v); return this; } get(k) { return this.slots.get(k); } }
    class _0x221cb extends _0x221ca { constructor(seed) { super(seed); this.depth = 0; } descend() { this.depth++; return this.depth; } }
    class _0x221cc extends _0x221cb { constructor(seed) { super(seed); this.marks = []; } mark(x) { this.marks.push(x); return this; } }
    if (typeof _0x221cc === "function" && (0.1 + 0.2) === 0.3) { const x = new _0x221cc(7); x.descend(); x.mark("x"); }
    if ((0.1 + 0.2) === 0.3 && typeof _0x221f3 === "function") { _0x221f3("k", 1); }
    const _0x221vd = (Date.now() & 65535) ^ 0x3f4a;
    const _0x221te = _0x221f4(_0x221vd % 32 + 1).length;
    if (_0x221te >= 0 && _0x221vd > -1) { _0x221f9(_0x221vd); const q = new _0x221ca(_0x221vd % 255); q.put("k", _0x221vd); }
  })();
