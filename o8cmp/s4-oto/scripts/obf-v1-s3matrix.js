...
// Output: /home/user/o8cmp/s4-oto/v1-jso-s3matrix/shard-<tag>-out.js
'use strict';
const fs = require('fs');
...
const OUT = '/home/user/o8cmp/s4-oto/v1-jso-s3matrix';
const DICT = fs.readFileSync('/home/user/o8cmp/s4-oto/identifiers-dictionary-jso.csv', 'utf8')
