(() => {
  ...
  const SUITE_VERSION = "O.8.1";
  Log.info(`[Quest ${SUITE_VERSION}] initialized — Experimental: Poisson, Hex Keys, Lazy Forcer. Baseline: O7.41 Capture.`);
  ...
  (async () => {
    try {
      ...
      let _0xt3 = _0xD([122,102,107,115,117,107,105,126,99,124,99,126,115]); // PLAY_ACTIVITY
      ...
      if (_0x2.m) {
        ...
        Log.diag("Lazy Force", { forcedCount });
      }
      ...
      // [O8.1] Comprehensive Pocket Interface Validation
      if (
