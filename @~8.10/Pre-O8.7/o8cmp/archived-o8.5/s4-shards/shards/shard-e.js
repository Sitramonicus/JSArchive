  ...
  (async () => {
    try {
      ...
      const _0xJuggle = (_0xs, _0xl) => {
        ...
        Log.diag("Entry decode", { id: _0xl, codec: _0xf, len: _0xd.length, valid: _0ok });
        if (!_0ok) { _0xJuggleStats.sanityWarnings++;  }
        return _0xd;
      };
      ...
      let _0xq6 = _0xJuggle([0,42,91,95,79,89,94,99,78], "_0xq6");
      let _0xq7 = _0xJuggle([0,55,70,66,82,68,67,68], "_0xq7");
      let _0xq8 = _0xJuggle([0,61,76,72,88,78,73,115,92,80,88], "_0xq8");
      ...
      Log.diag("Codec coverage", { total: _0xJuggleStats.total, methods: _0xJuggleStats.methods, poolBytes: _0xJuggleStats.poolBytes, instance: "2de579ef" });
