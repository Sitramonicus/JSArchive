...
spec = importlib.util.spec_from_file_location('lex', '/home/user/o8cmp/tools/lexicon-o842.py')
# lexicon-o842.py executes its reassign logic on import; instead parse pools only
lex_txt = open('/home/user/o8cmp/tools/lexicon-o842.py', encoding='utf-8').read()
