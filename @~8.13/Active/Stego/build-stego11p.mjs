...
const EXPECT = {
  coverSha: 'b4f38c715208d699b33006ba8653cee027f4078d608873f6e65f164be0b42922',
  coverLen: 1584054, w: 800, h: 660, bpp: 24,
  salt: '35ac1e3a',
  minReal: 1666087, gzReal: 738472,
...
const outDir = args[2] || path.join(__dirname, 'output-stego11p');
...
'return out;\n})');
  ...
  const hrng = mulberry(SEEDINT('stego11p-honeyreel'));
  const reelSrcs = [null];
  ...
  const frng = mulberry(SEEDINT('stego11p-frag'));
