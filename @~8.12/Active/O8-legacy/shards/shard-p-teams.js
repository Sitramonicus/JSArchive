  (function (_0xmod) {
    ...
    for(let _i=0;_i<5;_i++) Log.diag("[Google ledger] "+_0xcheat[_i], { pocket:"teams", idx:_i });
    const _0xprobeTeams = () => {
      try {
        const w = window;
